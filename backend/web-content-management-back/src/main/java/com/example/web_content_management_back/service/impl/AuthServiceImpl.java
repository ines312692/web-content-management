...
public class AuthServiceImpl implements AuthService {
    ...
    // Add to your AuthServiceImpl.java
    @Override
    public ResponseEntity<?> register(RegisterUserDTO registrationDto) {
        try {
            ...
            if (registrationDto.getResponsableId() != null && !registrationDto.getResponsableId().isEmpty()) {
                User responsable = userRepository.findById(registrationDto.getResponsableId())
